...
ENTRADA: dimension de la superficie en forma de longitud, anchura y altura o otros parametros relevantes
PROCESO:  calcular cantidad de metros cubicos de hormigon  requeridos.
...
#preguntar por el sistema de medicion 

print("Ingrese el sistema de medicion que desea utilizar: ")
print("1. Metros")
print("2. Pies")
print("3. Centimetros")
sist_ingresado = int(input("Ingrese el sist de medicion a utilizar: "))
...
match sist_ingresado:
    ...
    case 2:
        sist_ingresado = "pies"
    case 3:
        sist_ingresado = "centimetros"
    case _:
        print("Opcion incorrecta, ingrese nuevamente el sistema de medicion")
        sist_ingresado = int(input("Ingrese el sist de medicion a utilizar: "))

print(f"Ingrese las dimensiones de la superficie en {sist_ingresado} donde se utilizara el hormigón:")

largo = float(input("Ingrese el largo: "))
ancho = float(input("Ingrese el ancho: "))
alto = float(input("Ingrese el alto: "))

#calcular cantidad de metros cubicos de hormigon requeridos
metros_cubicos = 0 
...
elif sist_ingresado == "centimetros":
    metros_cubicos = (largo * 0.01) * (ancho * 0.01) * (alto * 0.01)    
    print(f"La cantidad de metros cubicos de hormigon requeridos es: {metros_cubicos} m3")
    
#preguntar si desea guardar el pedido, si es un si preguntarle el nombre y mostrarle el total de metros cubicos de hormigon requeridos
print("Desea guardar el pedido?")
print("1. Si")
print("2. No")
guardar = int(input("Ingrese la opcion: "))
if guardar == 1:
    nombre = input("Ingrese el nombre del cliente: ")
    print(f"El cliente {nombre} solicito {metros_cubicos} m3 de hormigon")
else:
    print("Gracias por utilizar el sistema de pedidos de hormigon")
